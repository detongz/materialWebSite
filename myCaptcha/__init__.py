...
class Captcha(object):
    ...
    def _set_answer(self,answer):
        ...
        """
        self.django_request.set_secure_cookie(self.session_key , str(answer))
    ...
    def display(self):
        ...
        # clean
        self.django_request.set_secure_cookie(self.session_key,'' )
        ...
        im.save(buf,'gif')
        buf.closed
        self.django_request.set_header('Content-Type', 'image/jpg')
        return self.django_request.write(buf.getvalue())
    ...
    def check(self,code):
        ...
        _code = self.django_request.get_secure_cookie(self.session_key) or ''
        self.django_request.set_secure_cookie(self.session_key,'')
